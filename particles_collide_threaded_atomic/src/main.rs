...
fn main()
{
    ...
    while Instant::now() < end_at {
        ...
        let collisions = particle_sys.test_collisions(&mut pool);

        println!("[{}]: {} collisions", iterations, collisions);
    ...
    println!("Finished {} iterations in {} seconds, with {} total collisions.", iterations, duration.as_secs(), total_collisions);
